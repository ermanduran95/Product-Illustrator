...
# Contents
* [How to Use](https://github.com/ermanduran95/Product-Recommender/blob/master/README.md#how-to-use)
  * [Using in oxxo.com](https://github.com/ermanduran95/Product-Recommender/blob/master/README.md#Option:1-Using-in-oxxo.com)
  * [Customize the program](https://github.com/ermanduran95/Product-Recommender/blob/master/README.md#Option:2-Customization)
* [Installing](https://github.com/ermanduran95/Product-Recommender/blob/master/README.md#Installing)

# How to Use

## Option:1 Using-in-oxxo.com
  In order to develop the program www.oxxo.com.tr was taken as an example. Without any change program can be used in the website after [installation](https://github.com/ermanduran95/Product-Recommender/blob/master/README.md#Installing).
...
## Option:2 Customization
  ...
  * Step-1 [install](https://github.com/ermanduran95/Product-Recommender/blob/master/README.md#Installing) the program.
